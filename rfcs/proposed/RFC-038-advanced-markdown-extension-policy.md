...
Defines how bekoedit evaluates support for Markdown extensions beyond MVP.

---

## 2. Motivation

- Markdown dialect sprawl can undermine source preservation.
- The app needs a principled extension policy.

---

## 3. Goals

- Classify extensions as render-only, raw-island, safe-editable, or unsupported.
- Require source-preservation tests for editable support.

---

## 4. Non-Goals

- Support every Markdown dialect.
- Invent a proprietary Markdown format.
...
- Settings may show enabled Markdown features and their editability.
...
```rust
enum ExtensionSupportLevel { RenderOnly, RawIsland, SafeEditable, Unsupported }
```
...
- Add extension support only through RFCs and golden tests.
...
- No extension becomes visually editable without preservation tests.
