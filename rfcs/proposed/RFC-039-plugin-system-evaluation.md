# RFC-039: Plugin System Evaluation
...
Evaluates whether bekoedit should ever provide a plugin API and under what constraints.

---

## 2. Motivation

- Plugins can expand capability but threaten simplicity, safety, and source preservation.

---

## 3. Goals

- Evaluate plugin need after MVP.
- Define security and stability risks.
- Consider limited command/theme plugins before document-mutating plugins.

---

## 4. Non-Goals

- Implement plugin system in MVP.
- Allow plugins to bypass Rust source safety.
...
- No user-facing plugin UI exists in MVP.
...
```rust
struct PluginCapability { name: String, can_read_files: bool, can_mutate_documents: bool }
```
...
- Any future plugin system must use capability boundaries and cannot directly write canonical text.
...
- Decision may be reject/defer/adopt-limited with explicit rationale.
