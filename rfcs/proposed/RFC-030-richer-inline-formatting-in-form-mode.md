# RFC-030: Richer Inline Formatting in Form Mode
...
Extends Form Mode inline editing beyond MVP basics while maintaining source preservation.

---

## 2. Motivation

- Users expect visual editing of links, emphasis, code, and possibly images.
- Inline Markdown syntax has many edge cases.

---

## 3. Goals

- Define inline node identity.
- Support safe toggles for emphasis, strong, inline code, links, and strikethrough if enabled.
- Preserve surrounding text and escaping.

---

## 4. Non-Goals

- Implement arbitrary nested inline transformations without tests.
- Adopt rich-text persistence format.
...
- Inline toolbar appears for selected text with minimal actions.
...
- Inline edits should be generated by Rust from semantic commands and tested with punctuation, Japanese text, and nested emphasis.
...
- Inline operations do not corrupt UTF-8 or surrounding Markdown.
