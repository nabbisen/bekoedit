...
Releases 0.1.0 to 0.9.1, moved here unchanged from [`CHANGELOG.md`](../CHANGELOG.md) when the 0.10 series
began. The rules are in [the changelog policy](../docs/src/changelog-policy.md).
...
[0.7.1]: https://github.com/nabbisen/bekoedit/releases/tag/0.7.1
