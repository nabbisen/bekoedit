...
fn tr_en(key: &str) -> &'static str {
    match key {
        ...
        "explorer.cancel_new_file" => "Cancel new file",
        "explorer.new_file_name" => "New file name",
        "explorer.create" => "Create",
        "explorer.label" => "Workspace explorer",
        "explorer.no_workspace" => "Open a workspace to browse files.",
        ...
        "block.kind.paragraph" => "Paragraph",
        "block.kind.blockquote" => "Blockquote",
        "block.kind.list" => "List",
        "block.kind.code" => "Code block",
        "block.kind.horizontal_rule" => "Horizontal rule",
        ...
        "menu.editor_tools" => "Editor tools",
...
fn tr_ja(key: &str) -> &'static str {
    match key {
        ...
        "explorer.cancel_new_file" => "新規ファイルをキャンセル",
        "explorer.new_file_name" => "新規ファイル名",
        "explorer.create" => "作成",
        "explorer.label" => "ワークスペースエクスプローラ",
        "explorer.no_workspace" => "ファイルを表示するにはワークスペースを開いてください。",
        ...
        "block.language" => "言語",
        "block.kind.heading" => "見出し",
        "block.kind.paragraph" => "段落",
        "block.kind.blockquote" => "引用",
        "block.kind.list" => "リスト",
        "block.kind.code" => "コードブロック",
        "block.kind.horizontal_rule" => "水平線",
        "block.kind.table" => "表",
        "block.kind.image" => "画像",
        "table.add_row" => "行を追加",
        ...
        "menu.app" => "アプリケーションメニュー",
        "menu.editor_tools" => "エディタツール",
        "settings.title" => "設定",
        "settings.close" => "閉じる",
        "settings.save" => "設定を保存",
        "settings.general" => "一般",
